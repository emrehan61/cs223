...
HD_PWD='C:/Users/emrho/Desktop/CS223/proje4/proje4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fourdflipflop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fourdflipflop.tcl
