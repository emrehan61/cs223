...
HD_PWD='C:/Users/emrho/Desktop/CS223/proje4/proje4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fourdflipflop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fourdflipflop.tcl -notrace
