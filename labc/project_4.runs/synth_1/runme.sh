...
HD_PWD='C:/Users/emrho/Desktop/CS223/labc/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log labcalc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source labcalc.tcl
