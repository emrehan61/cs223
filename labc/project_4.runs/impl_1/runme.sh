...
HD_PWD='C:/Users/emrho/Desktop/CS223/labc/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log labcalc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source labcalc.tcl -notrace
