...
HD_PWD='C:/Users/emrho/Desktop/CS223/labproject/labproject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log projectmain.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source projectmain.tcl -notrace
