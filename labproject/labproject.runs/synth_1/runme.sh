...
HD_PWD='C:/Users/emrho/Desktop/CS223/labproject/labproject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log projectmain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source projectmain.tcl
