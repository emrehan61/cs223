...
HD_PWD='C:/Users/emrho/Desktop/CS223/lab5/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tlights.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tlights.tcl -notrace
