...
HD_PWD='C:/Users/emrho/Desktop/CS223/lab5/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tlights.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tlights.tcl
